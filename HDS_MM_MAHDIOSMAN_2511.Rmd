...
From a biological standpoint, it would be reasonable to expect that some disease-modifying therapies (DMTs) could increase susceptibility to infection, including COVID-19, because several act by modulating immune function. In particular, therapies such as rituximab, which deplete B cells, have been associated with more severe COVID-19 outcomes. [1]
